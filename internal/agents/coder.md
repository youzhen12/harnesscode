...
- For that feature, read the corresponding technical design / spec from `.harnesscode/docs/` and project root `docs/` (when available), so that your implementation strictly follows the documented plan
- Implement the feature in the project codebase
...
- Keep changes minimal and focused around the selected feature and its documented behavior
- When you decide a feature is already implemented, explain which concrete files, functions, and docs you inspected, then only update the status
